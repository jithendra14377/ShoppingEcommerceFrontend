...
//                     onClick={() =>
//                       navigate("/payment", { state: { type: "cart" } })
//                     }
//                   >
//                     Proceed to Payment →
//                   </button>
...
function Cart() {
  ...
  async function fetchCart() {
    try {
      ...
      const res = await axios.get(`${API_URL}/api/cart/view`, {
        withCredentials: true,
      });
  ...
  async function removeItem(itemid) {
    try {
      ...
      console.log("REMOVE CART ITEM:", itemid);

      const res = await axios.delete(`${API_URL}/api/cart/remove/${itemid}`, {
        withCredentials: true,
      });
