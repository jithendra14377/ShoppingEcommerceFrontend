...
function Navbar() {
  ...
  async function logout() {
    try {
      ...
      if (user) {
        await fetch("https://shopiecomreact.duckdns.org/api/admin/logout", {
          method: "POST",
          credentials: "include",
        });
          ...
          <ul className="navbar-nav mb-2 mb-lg-0">
            ...
            {user && (
              <>
                ...
                <li className="nav-item">
                  <Link className="nav-link custom-link" to="/produce">
                    Products
                  </Link>
                </li>
                ...
                <li className="nav-item">
                  <Link className="nav-link custom-link" to="/my-orders">
                    Orders
                  </Link>
                </li>
